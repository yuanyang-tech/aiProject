...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange }) => {
  const menuItems = [
    ...
    { id: DashboardTab.KNOWLEDGE, icon: (
  ...
  return (
    <aside className="w-20 lg:w-64 bg-slate-900 text-slate-400 flex flex-col h-screen sticky top-0 transition-all duration-300">
